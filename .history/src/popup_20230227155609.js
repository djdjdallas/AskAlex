  ...
  return (
    <div className="ml-4 popup w-[91%] flex flex-col bg-gradient-to-r from-[#f9fbfc] to-[#eef4fd] rounded-lg">
      <div className="flex justify-center items-center w-[100%] mt-3">
        {!suggestions ? (
          <div className=" w-[90%] h-[100%] mt-4 text-xl space-y-3 flex-row justify-center items-center">
            ...
            <div className="border-[1px] border-purple-300 rounded-md shadow-lg p-4 bg-white ">
              <h1
                style={{
      ...
      <div className="flex justify-center items-center my-5">
        <input
          ...
          className="shadow outline-none focus:outline-none focus:ring text-sm font-bold border-2 border-[#E7EAFB] rounded-md w-[90%]  h-20 placeholder:text-black placeholder:pl-1
          "
          type="text"
          value={prompt}
      ...
      <button
        style={{ fontFamily: "Baskeville" }}
        className="cursor-pointer text-2xl font-bold bg-gradient-to-r from-[#8C61FF] to-[#0BB2FF] rounded-md p-2 m-5 text-white
        ...
        >
          {suggestions.map((suggestion, index) => (
            ...
            >
              ...
              >
                <BsClipboardCheck className="ml-2 cursor-pointer" />
              </button>
            </li>
          ))}
        </ul>
