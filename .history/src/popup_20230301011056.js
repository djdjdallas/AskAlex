  ...
  return (
    <div className="ml-4 popup w-[91%] flex flex-col bg-gradient-to-r from-[#f9fbfc] to-[#eef4fd] rounded-lg">
      <div className="flex justify-center items-center w-[100%] mt-3">
        {suggestions ? (
          <div className="infoContainer w-[90%] h-[100%] mt-4 text-xl space-y-3 flex-row justify-center items-center">
            <div className="infoBox border-[1px] border-purple-300 p-4 rounded-md shadow bg-white ">
      ...
      {suggestions.length === 0 && (
        <div className="infoContainer w-[90%] h-[100%] mt-4 text-xl space-y-3 flex-row justify-center items-center">
          <div className="infoBox border-[1px] border-purple-300 p-4 rounded-md shadow bg-white ">
            <h1 className="subText" style={{ fontFamily: "Baskeville" }}>
              Ask Alex allows users to generate helpful and creative suggestions
              for various prompts using advanced artificial intelligence
              technology.
            </h1>
          </div>
          <div className="infoBox border-[1px] border-purple-300 rounded-md shadow-lg p-4 bg-white ">
            ...
            >
              With just a few clicks, users can input their prompts and receive
              customized suggestions that can be used for a variety of
              applications, including writing, brainstorming, and
              problem-solving.
            </h1>
          </div>
